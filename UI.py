...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(10, 90, 1221, 471))
        ...
        self.horizontalLayout.addWidget(self.pic_view_1)
        ...
        self.horizontalLayout.addWidget(self.pic_view_2)
